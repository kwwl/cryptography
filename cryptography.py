...
def vigenere_cipher(text, password):
    ...
    for index, char in enumerate(text):
        ...
        crypted_char = chr((ord(char) + current_key) % 1114112)
        crypted_text.append(crypted_char)
...
if __name__ == "__main__":
    ...
    vigenere_crypted = vigenere_cipher(message, password)
    print("Vigenère crypté :", vigenere_crypted)
